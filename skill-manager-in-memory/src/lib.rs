use crate::{
    employees::{employees_api, employees_api_using, EmployeeApi, EmployeeDb},
    projects::{projects_api, projects_api_using, ProjectDb, ProjectsApi},
    skills::{skills_api, skills_api_using, SkillDb, SkillsApi},
};
